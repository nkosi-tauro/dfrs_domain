...
urlpatterns = [
    ...
    path("dfrsadmin/reports/<int:primary_key>",
         views.reportsdetail, name="reports-detail"),
    path("dfrsadmin/internalreportsdetail/<int:primary_key>",
         views.internalreportsdetail, name="internal-reports-detail"),
    path("dfrsadmin/reports/delete/<int:primary_key>",
         views.reports_delete, name="reports-delete"),
    path("dfrsadmin/external_reports/update/<int:primary_key>",
         views.reports_update, name="reportsupdate"),
    path("dfrsadmin/internal_reports/update/<int:primary_key>",
         views.internalreports_update, name="internal-reportsupdate"),
    ...
    path("logout/",
         auth_views.LogoutView.as_view(template_name="homeview/logout.html"),
         name="employee-logout"),
    # Employee Routes
    path("employee/<int:user_id>", views.employeeview, name="employeeview"),
    path("employee/update/<int:user_id>",
         views.employeeupdate, name="profile-update"),
    path("employee/<int:user_id>/flaw", views.add_flaw, name="add-flaw"),
    path("employee/<int:user_id>/remove/<int:flaw>",
         views.remove_flaw, name="remove-flaw"),
    path("employee/<int:user_id>/edit/<int:flaw>",
         views.edit_flaw, name="edit-flaw"),
    # Public Routes
