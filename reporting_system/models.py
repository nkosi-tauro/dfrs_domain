...
class ReportingFormModel(models.Model):
    ...
    type_of_vulnerability = models.CharField(
        max_length=30, choices=Vulnerability_Type, serialize=True, blank=False
    )
...
class VulnerabilityFormModelUpdated(models.Model):
    ...
    type_of_vulnerability = models.CharField(
        max_length=100, choices=Vulnerability_Type, blank=False, serialize=True
    )
    severity = models.CharField(
        max_length=10, choices=CHOICES, blank=False, serialize=True
    )
...
class VulnerabilityFormModel(models.Model):
    ...
    type = models.CharField(
        max_length=100, choices=Vulnerability_Type_Flaw, blank=False, serialize=True
    )
    severity = models.CharField(
        max_length=10, choices=CHOICES, blank=False, serialize=True
    )
